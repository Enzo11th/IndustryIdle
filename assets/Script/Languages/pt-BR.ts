export const PT_BR = {
    ...
    EdgePanEdgeSensitivity: "",
    EdgePanEdgeSensitivityDesc: "A sensibilidade do movimento da câmera - quanto maior o número, mais sensibilidade.",
    GameControllerSupport: "Suporte para Controle de Jogo",
    GameControllerSupportDesc: "Ative o suporte para controle de jogo - geralmente, é melhor deixar ativado.",
    ...
    GameControllerCursorSensitivity: "Sensibilidade do Cursor do Controle de Jogo",
    ...
    PlayerTradeBetterTradesAvailable:
        "Há %{count} troca(s) que dão mais lucro ",
    PlayerTradeBetterTradesAvailableAction: "Me mostre essas trocas",
    BuildingCount: "Quantidade",
    NoEfficiencyDesc: "Essa construção não se beneficia das políticas a seguir:",
    AuthenticationSendSuccess: "Seu pedido de autenticação foi enviado com sucesso!",
    AuthenticationSendFail: "Falha ao mandar pedido de autenticação: %{message}",
    Authenticate: "Autenticar sua conta",
    PlatformCheck: "Conta conectada",
    PlatformCheckDesc: "Sua conta já foi logada em outro perfil ou dispositivo",
    FreeWeeklyCityDesc: "%{city} está disponível para todos os jogadores sem necessidade de pacote de expansão!",
    HideCivIdleBanner: "Esconder banner do CivIdle",
    HideCivIdleBannerDesc: "Esconde o banner do CivIdle do menu de configuração",
    MobileAdDLCOwner:
        "Se você tem um pacote de expansão, pode dobrar o valor a raceber do tempo que ficou offline",
