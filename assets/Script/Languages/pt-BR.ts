export const PT_BR = {
    ...
    Screen: "Tela",
    JoinDiscord: "Junte-se ao nosso servidor no Discord para novidades, dicas e discussões",
    ...
    Tips7: "Se você comprar um recurso,o preço aumentará. Se você vender um recurso,reduzirá o preço dele.",
    ...
    RewardAdsFailed: "O vídeo de recompensa não foi assistido por completo",
    ...
    WindTurbineAlwaysWork: "Rajadas de vento",
    ...
    QuantumComputerLab: "Laboratório do Computador Quântico",
    QuantumComputer: "Computador Quântico",
    TVStudioPlus: "TV Studio+",
    SetAsDefault: "Padrão",
    ClearTradesTitle: "Limpar as trocas",
    ClearTradesDescription:
        "Dinheiro e trocas não serão reembolsadas - Só use se tiver trocas velhas no servidor",
    ClearTradesNo: "Não limpar as trocas",
    ClearTradesYes: "Limpar as trocas feitas",
    OnlyShowPositiveModifiers: "Mostrar apenas modificadores positivos",
    OnlyShowPositiveModifiersHint: "Tick the checkbox on the left of the building to show tile modifiers on the map",
    ClearMyTradesV2: "Limpar todas as trocas",
    ...
    GameSettingDesc: "Configure o jogo para melhor se adaptar.",
    GameSettingGeneral: "General",
    GameSettingDisplay: "Display",
    GameSettingHideElements: "Esconded",
    ...
    GameSettingBuildWarningPowerBankDesc:
        "Desativa o aviso de quando for tentar colocar um power bank que não está do lado de uma usina de energia.",
    ...
    GameSettingVolumeControl: "Controlar volume do jogo",
    ...
    GameSettingSFXCompleted: "Troca feita",
    ...
    GameSettingSFXFreeChest: "Coletar ganhos offline",
